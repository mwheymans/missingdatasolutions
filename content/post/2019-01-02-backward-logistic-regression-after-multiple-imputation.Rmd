...
description: With the [psfmi](/psfmi/) package it is possible to do backward selection for logistic regression models after Multiple Imputation (MI). For backward selection, several variable selection criteria can be used. These criteria are called the D1, D2, Meng and Rubin (MR or D3) and Median P-rule (MPR).
