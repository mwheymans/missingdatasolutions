...
`cv_MI`, `cv_MI_RR` and `MI_cv_RR`. An explanation and examples of how to use the
...
How this method works is visualized in Figure \@ref(fig:fig1) 

![Test](cv_mi.jpg)

```{r fig1, echo = FALSE, fig.cap="\\label{fig:fig1} Schematic overview of the cv_MI method", out.width='100%', fig.align='center'}
knitr::include_graphics("cv_MI.jpg")
```
...
How these steps work is visualized in figure (Figure \@ref(fig:fig2)) 

```{r fig2, echo = FALSE, fig.cap="\\label{fig:fig2} Schematic overview of the cv_MI_RR method", out.width='100%', fig.align='center'}
knitr::include_graphics("cv_mi_RR.jpg")
...
in the figure (Figure \@ref(fig:fig3)) 

```{r fig3, echo = FALSE, fig.cap="\\label{fig:fig3} Schematic overview of the MI_cv_naive method", out.width='100%', fig.align='center'}
knitr::include_graphics("MI_cv_naive.jpg")
